...
public class EmployeeService {
	...
	// url to call this method -->
	// http://localhost:8080/jersey-rest/rest/empService/employees

	@GET
	@Path("/employees")
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	// producer annotation tells the server that send response as xml
	public Response listEmployees() {
		/**
		 * GenericEntity can be used to represent a response entity of a generic
		 * type
		 */
		GenericEntity<Collection<Employee>> entity = new GenericEntity<Collection<Employee>>(
				employees.values()) {
		};
	...
	// http://localhost:8080/jersey-rest/rest/empService/employee/1
	@GET
	...
	// to get json format of respose -->
	// http://localhost:8080/jersey-rest/rest/empService/json/employees
	@GET
	@Path("/json/employees/")
	@Produces("application/json")
	public ArrayList<Employee> listEmployeesJSON() {

		return new ArrayList<Employee>(employees.values());
	}

	// to get json of single request -->
	// http://localhost:8080/jersey-rest/rest/empService/json/employee/1
	@GET
	...
	// this method called from index.jsp to add new record -->
	// http://localhost:8080/jersey-rest/index.jsp
	static int i = 2;
	...
	// http://localhost:8080/jersey-rest/rest/empService/2011;author=thirupathiReddy;country=india
	@GET
	@Path("{year}")
	public Response getBooks(@PathParam("year") String year,
		...
		return Response
				.status(200)
				.entity("you requested following book details: published year "
						+ year + ", author : " + author + ", country : "
						+ country).build();

	}

	// http://localhost:8080/jersey-rest/rest/empService/query?from=100&to=200&orderBy=age&orderBy=name&orderBy=date&orderBy=year
	@GET
	@Path("/query")
	...
	// http://localhost:8080/jersey-rest/rest/empService/1
	@GET
	@Path("{id}")
	@Produces("text/plain")
	...
	// http://localhost:8080/jersey-rest/rest/empService/hello
	@GET
	@Path("/hello")
	@Produces("text/plain")
	public String hello() {
	...
	// http://localhost:8080/jersey-rest/rest/empService/echo/hello
	@GET
	@Path("/echo/{message}")
	@Produces("text/plain")
