...
<portlet:actionURL var="deleteEmployeeURL">
<portlet:param name="action" value="delete"></portlet:param>
</portlet:actionURL>

<form:form name="employee" modelAttribute="employee" method="post" action="${addEmployeeURL}" >
	<table>
	<tr>
...
<c:forEach items="${employeeList}" var="emp">
	<tr>
		...
		<td>${emp.email}</td>
		<td>${emp.telephone}</td>
		<td><a href="${deleteEmployeeURL}&empId=${emp.id}">delete</a></td>
	</tr>
</c:forEach>
</table>
</c:if>
