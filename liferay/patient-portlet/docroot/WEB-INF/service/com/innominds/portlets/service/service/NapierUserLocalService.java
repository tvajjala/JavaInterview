...
/**
 * Provides the local service interface for NapierUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NapierUserLocalServiceUtil
...
public interface NapierUserLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NapierUserLocalServiceUtil} to access the napier user local service. Add custom service methods to {@link com.innominds.portlets.service.service.impl.NapierUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
