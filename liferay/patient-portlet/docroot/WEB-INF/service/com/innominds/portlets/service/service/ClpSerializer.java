...
import com.innominds.portlets.service.model.NapierUserClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"patient-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "patient-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.innominds.portlets.service.model.impl.NapierUserImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.innominds.portlets.service.NoSuchNapierUserException")) {
			return new com.innominds.portlets.service.NoSuchNapierUserException();
		}
