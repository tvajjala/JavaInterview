...
<script src="<%=request.getContextPath()%>/js/boxover.js"
	type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/js/jquery-1.3.2.min.js"
	type="text/javascript"></script>
<title>${FULLNAME} <tiles:getAsString name="title" /></title>
</head>
...
<body class="outertbl">
	...
	<table border="0" width="100%" align="center" id="virtualform"
		...
		<tbody>
			...
			<tr>
				<td width="20%" valign="top" class="sidemenu"><tiles:insertAttribute
						name="menu-content" /></td>
				<td width="80%"><tiles:insertAttribute name="body-content" /></td>
			</tr>
